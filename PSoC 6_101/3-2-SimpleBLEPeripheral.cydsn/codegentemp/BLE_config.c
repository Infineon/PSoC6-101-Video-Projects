...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x06u, 0x09u, 0x50u, 0x36u,
        0x4Cu, 0x45u, 0x44u, 0x11u, 0x07u, 0x37u, 0x82u,
        0xA8u, 0xB5u, 0x6Fu, 0x31u, 0xC4u, 0x9Au, 0xA1u,
        0x48u, 0xF5u, 0xF5u, 0x25u, 0xACu, 0xEEu, 0xE6u,
...
static uint8_t cy_ble_attValues[0x2Bu] = {
    /* Device Name */
    (uint8_t)'P', (uint8_t)'6', (uint8_t)'L', (uint8_t)'E', (uint8_t)'D', 
...
(uint8_t)'i', (uint8_t)'g', (uint8_t)'h', (uint8_t)'n', (uint8_t)'e', (uint8_t)'s', (uint8_t)'s', (uint8_t)' ',
(uint8_t)'0', (uint8_t)'-', (uint8_t)'1', (uint8_t)'0', (uint8_t)'0', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Bu] = {
    ...
    { 0x0015u, (void *)&cy_ble_attValues[22] }, /* Characteristic User Description */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x13u] = {
    ...
    { 0x0012u, 0x9345u /* GREEN                               */, 0x09080100u /* wr    */, 0x0013u, {{0x0001u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd    */, 0x0013u, {{0x0015u, (void *)&cy_ble_attValuesLen[10]}} },
};
