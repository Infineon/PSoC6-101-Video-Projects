...
module BLE_PDL_v2_0_7 (
    ...
    bIncludeDriverToComponent_v1_0_6 IncludeBleLibs ();
...
module top ;
	...
	wire [0:0] tmpFB_0__M_1_net;
	wire [0:0] tmpIO_0__M_1_net;
	electrical [0:0] tmpSIOVREF__M_1_net;
	...
	cy_mxs40_gpio_v1_0
		...
		M_1
		 (.oe({1'b1}),
		  .y({Net_21}),
		  .fb({tmpFB_0__M_1_net[0:0]}),
		  .io({tmpIO_0__M_1_net[0:0]}),
		  .siovref(tmpSIOVREF__M_1_net));


	wire [0:0] tmpFB_0__M_2_net;
	wire [0:0] tmpIO_0__M_2_net;
	electrical [0:0] tmpSIOVREF__M_2_net;
	...
	cy_mxs40_gpio_v1_0
		...
		M_2
		 (.oe({1'b1}),
		  .y({Net_35}),
		  .fb({tmpFB_0__M_2_net[0:0]}),
		  .io({tmpIO_0__M_2_net[0:0]}),
		  .siovref(tmpSIOVREF__M_2_net));
    ...
    begin
        cy_tff_1 <= Net_43^Net_45;
    end
    assign Net_45 = cy_tff_1;
    // -- TFF End --
    ...
    assign Net_61 = ~Net_45;

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_57 or Net_62 or Net_45)
        begin
            case (Net_45)
                1'b0 :  tmp__mux_1_reg = Net_57;
                1'b1 :  tmp__mux_1_reg = Net_62;
            endcase
        end
        assign Net_60 = tmp__mux_1_reg;
    end
    // -- Mux end --
