...
#define CY_BLE_CUSTOMC_MOTOR_M1_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
...
#define CY_BLE_CUSTOMC_MOTOR_M2_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
...
#define CY_BLE_CUSTOMC_MOTOR_M1_REL_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M2_REL_CHAR_INDEX   (0x03u) /* Index of M2_REL characteristic */
#define CY_BLE_CUSTOMC_MOTOR_M2_REL_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
